...
../system/src/stm32f1-hal/stm32f1xx_hal_rcc_ex.c \
../system/src/stm32f1-hal/stm32f1xx_hal_uart.c 
...
./system/src/stm32f1-hal/stm32f1xx_hal_rcc_ex.o \
./system/src/stm32f1-hal/stm32f1xx_hal_uart.o 
...
./system/src/stm32f1-hal/stm32f1xx_hal_rcc_ex.d \
./system/src/stm32f1-hal/stm32f1xx_hal_uart.d 
...
system/src/stm32f1-hal/%.o: ../system/src/stm32f1-hal/%.c system/src/stm32f1-hal/subdir.mk
	...
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -Og -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -fno-move-loop-invariants -Wall -Wextra -g3 -DDEBUG -DUSE_FULL_ASSERT -DSTM32F103xB -DUSE_HAL_DRIVER -DHSE_VALUE=8000000 -I"../include" -I"D:\Projects\EclipceWorkspace\bt_keyboard\keyb\inc" -I"../system/include" -I"../system/include/cmsis" -I"../system/include/stm32f1-hal" -std=gnu11 -Wno-unused-parameter -Wno-conversion -Wno-sign-conversion -Wno-bad-function-cast -Wno-unused-variable -Wno-implicit-function-declaration -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
